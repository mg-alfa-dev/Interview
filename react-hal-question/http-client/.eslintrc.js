 ...
 * @typedef {Partial<typeof import('@typescript-eslint/eslint-plugin/dist/rules').default>} TypescriptESLintRules
 * @typedef {Partial<import('eslint-plugin-react')['rules']>} ReactESLintRules
 **/
...
const eslintRules = {
  ...
  'no-redeclare': ['off'],
  // 'no-redeclare': ['error'], // for some reason enabling this rule breaks typescript interface merging after moving the file to ../common
  'no-shadowed': ['off'],
